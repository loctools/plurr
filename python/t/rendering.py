...
t('3.4', p, s, {'N': 5}, None, 'Удалить эти 5 файла навсегда?')
...
s = 'Удалить {N_PLURAL:этот {N} файл|эти {N} файла|эти {N} файлов} навсегда?'
p.set_locale('ru')
t('7.1', p, s, {'N': 5}, None, 'Удалить эти 5 файлов навсегда?')
t('7.2', p, s, {'N': 5}, {'locale': 'en'}, 'Удалить эти 5 файла навсегда?')
t('7.3', p, s, {'N': 5}, None, 'Удалить эти 5 файлов навсегда?')
p.set_locale('en');
t('7.4', p, s, {'N': 5}, None, 'Удалить эти 5 файла навсегда?')
